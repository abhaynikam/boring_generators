require_relative 'lib/boring/generators/version'

Gem::Specification.new do |spec|
  spec.name          = "boring-generators"
  spec.version       = Boring::Generators::VERSION
  ...
  spec.homepage      = "https://github.com/abhaynikam/boring-generators"
  spec.license       = "MIT"
  ...
  spec.add_development_dependency "rails", "~> 6.0.3.2"
  spec.add_development_dependency "railties", "~> 6.0.3.2"
end
